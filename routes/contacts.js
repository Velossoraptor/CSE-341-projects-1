...
router.post('/', validation.saveContact, contactsController.createNew); // Routes all POST /contacts requests to contacts.js createNew function

router.put('/:id', validation.saveContact, contactsController.updateContact); // Routes all PUT /contacts/:id-to-modify requests to contacts.js updateContact function
